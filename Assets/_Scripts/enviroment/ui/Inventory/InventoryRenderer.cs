...
namespace roguelike.rendering.ui {
    public class InventoryRenderer {
        ...
        public static void ClickSlot(Vector2 position, ItemSlot originalSlot, bool isPrimary) {
            ...
            if(clickedSlot.SlotStack.Item == _mouseSlot.SlotStack.Item &&
                ...
                // todo: add logic for splitting stacks
        ...
        private static void SplitSlot(ItemSlot clickedSlot) {
